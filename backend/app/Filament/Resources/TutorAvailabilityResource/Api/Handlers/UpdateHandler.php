...
use App\Filament\Resources\TutorAvailabilityResource\Api\Requests\UpdateTutorAvailabilityRequest;
...
class UpdateHandler extends Handlers {
     ...
     *
     * @param UpdateTutorAvailabilityRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateTutorAvailabilityRequest $request)
    {
        $id = $request->route('id');
